                        ...
                        <article class="post">
                            ...
                            <div class="post-img mb-5">
                                <div class="post_gallery owl-carousel owl-theme">
                                    <div class="item">
                                       <img class="img-fluid" src="images/fashion/img-1.jpg" alt=""/>
                                    </div>
                                    <div class="item">
                                        <img class="img-fluid" src="images/fashion/img-2.jpg" alt=""/>
                                    </div>
                                    <div class="item">
                                        <img class="img-fluid" src="images/fashion/img-3.jpg" alt=""/>
                                    </div>
                                </div>
                            </div>
                            <!--post gallery end-->
